...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-26 20:29`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/088feda6-ca0e-495d-a762-b023fc5a59cf.git
$ cd 088feda6-ca0e-495d-a762-b023fc5a59cf
```
